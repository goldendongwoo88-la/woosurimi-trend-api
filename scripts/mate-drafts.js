      ...
      const out = await runTool(job.skill, [
        ...
        { role: "assistant", content: "알겠습니다. 어느 단계를 진행할까요?" },
        {
          ...
          content:
            ...
            "강조 표기(꾸밈은 이 다섯 가지만, 남발 금지 — 글 전체에 형광 2~3곳·색 1~2곳 정도).\n" +
            "⚠️ 형광·색은 **결론·숫자·가격처럼 스캔하는 독자가 진짜 찾는 정보에만** 붙이세요.\n" +
            "아무 문장에나 붙이면 광고 전단처럼 읽힙니다:\n" +
            "  **굵게**  [형광]배경 강조[/형광]  [밑줄]밑줄[/밑줄]  [색]포인트 글자[/색]  [크게]크게[/크게]\n" +
            lenLine + "\n" +
