      ...
      const out = await runTool(job.skill, [
        ...
        { role: "assistant", content: "알겠습니다. 어느 단계를 진행할까요?" },
        {
          ...
          content:
            ...
            "강조 표기 5종을 **용도별로 골고루** 쓰세요 (한 종류만 반복 금지, 남발도 금지):\n" +
            "  [형광]…[/형광] = 글의 핵심 결론 2~3곳\n" +
            "  [색]…[/색] = 숫자·가격·날짜 1~2곳\n" +
            "  **굵게** = 브랜드·제품명·고유명사\n" +
            "  [밑줄]…[/밑줄] = 주의·조건 1곳\n" +
            "  [크게]…[/크게] = 글 전체의 한 줄 요약 1곳\n" +
            "⚠️ 아무 문장에나 붙이면 광고 전단처럼 읽힙니다 — 스캔하는 독자가 진짜 찾는 정보에만.\n" +
            "⚠️ **제품 정보 덩어리(브랜드/제품명/가격/출시일/핵심 특징)는 반드시 인용구(> 로 시작하는 줄)로 묶으세요.**\n" +
            "⚠️ **각 소제목(■) 바로 앞에 [사진: 그 구역에 어울리는 사진 설명] 자리를 하나씩** 두세요 — 구역마다 사진이 들어갑니다.\n" +
            "확인된 값만 쓰고, 모르는 가격은 '공식몰 확인'이라고 적으세요.\n" +
            lenLine + "\n" +
