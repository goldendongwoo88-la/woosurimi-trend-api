 ...
 *
 * ⚠️ 그리고 이 계산에서 **요금제가 밑진다**는 걸 알았습니다.
 *   프로 29,900원 · 하루 40크레딧을 다 쓰면 → 원가 288,610원/월
 * 마진을 남기려면 프로가 하루 6크레딧이어야 합니다. 지금은 40입니다.
 *
 * 그런데 하루 6크레딧이면 원고 한 편도 못 씁니다. 그런 상품은 안 팔립니다.
 *
 * ⚠️ 그래서 결론은 "크레딧을 줄이자"가 아닙니다.
 * **원고 생성은 이 가격대에서 API로 팔 수 없습니다.** 계산이 성립하지 않습니다.
 * 팔아야 할 것은 분석 기능입니다 — 진단·순위추적·키워드·홈피드 진단·줄바꿈·맞춤법.
 * 그건 우리 서버 품만 들고 돈이 안 나갑니다. 판다랭크·블라이가 파는 것도 그쪽입니다.
 *
 * 원고 생성은 셋 중 하나여야 합니다:
 *   1) 사장님 전용 — Claude Pro Max 구독으로 claude.ai에서 직접 (API 값 0원)
 *   2) 크레딧을 아주 적게 주고 맛보기로만
 *   3) 별도 고가 상품 (원고 10편에 3만원 식)
 *
 * ⚠️ 손님을 받기 전에 이 문제를 먼저 풀어야 합니다.
 * 지금 값을 그대로 두면 프로 손님 한 명당 한 달 25만원을 잃습니다.
 */
/**
