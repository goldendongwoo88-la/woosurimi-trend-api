...
const TOOLS = [
  {
    ...
    badge: "구글 SEO",
    title: "구글 상위 SEO 생성기",
    desc: "구글 SEO에 맞는 글쓰기를 진행해요",
    bullets: ["티스토리, 블로그스팟, 워드프레스 등 어디에 올려도 되는 구조로 작성"],
    inputLabel: "주제 또는 키워드",
    inputPlaceholder: "예) 노트북 배터리 오래 쓰는 법",
    system:
      "당신은 구글 검색 상위노출에 최적화된 SEO 블로그 글을 쓰는 전문 작가입니다. " +
      "제목(H1), 소제목(H2/H3) 구조, 메타 설명, 핵심 키워드를 자연스럽게 반복 배치하는 방식으로 " +
      "1000~1500자 분량의 한국어 블로그 글을 작성하세요. 답변은 바로 블로그에 붙여넣을 수 있는 " +
      "완성된 글(제목+소제목+본문) 형태로만 주세요." + HONESTY_RULE,
  },
  {
    id: "naver-seo",
    badge: "네이버 SEO",
    title: "네이버 검색 상위 SEO 생성기",
    desc: "네이버 검색 SEO에 맞는 글쓰기를 진행해요",
    bullets: ["키워드와 부연설명을 입력하면 전체 주제로 글 생성 가능"],
    inputLabel: "키워드 + 부연설명",
    inputPlaceholder: "예) 키워드: 여름철 에어컨 냄새 제거 / 부연설명: 필터 청소 위주로",
    system:
      "당신은 네이버 블로그 검색(스마트블록/뷰) 상위노출에 최적화된 글을 쓰는 전문 작가입니다. " +
      "D.I.A+ 로직(경험 정보, 정확한 정보, 신뢰할 수 있는 정보, 어뷰징 없음)을 의식해서, 자연스러운 " +
      "구어체 소제목과 2~3문장 단위 짧은 문단, 핵심 키워드의 자연스러운 반복 배치로 1000~1400자 분량의 " +
      "블로그 글을 작성하세요." + HONESTY_RULE,
  },
  {
    id: "naver-mate",
    badge: "메이트 전용",
    title: "네이버 MATE 글 생성기",
    desc: "경제·금융·복지·정책 등 전문 주제에 특화된 글 생성기예요",
    bullets: ["경제 및 금융, 복지 및 정책 전문 톤", "그 외 주제는 네이버 SEO 생성기 로직 활용"],
    inputLabel: "주제 (경제/금융/복지/정책 등)",
    inputPlaceholder: "예) 2026년 근로장려금 신청 조건",
    system:
      "당신은 경제·금융·복지·정책 주제를 다루는 네이버 블로그 전문 작가입니다. 딱딱하지 않으면서도 " +
      "신뢰감 있는 톤으로, 제도/정책 글은 '대상, 조건, 신청 방법, 유의사항' 순서로 명확하게 구조화해서 " +
      "1000~1400자 분량으로 작성하세요. 정확한 금액·기한·조건은 지어내지 말고 반드시 ✏️로 표시하세요." +
      HONESTY_RULE,
  },
  {
    id: "naver-homepan",
    badge: "홈판 노출",
    title: "네이버홈판모드",
    desc: "네이버 홈(추천피드) 노출에 유리한 글을 생성해요",
    bullets: ["기사 전체 원문 또는 '키워드'만 입력해도 작성 가능"],
    inputLabel: "기사 원문 또는 키워드",
    inputPlaceholder: "기사 전체를 붙여넣거나, 키워드만 입력하세요",
    system:
      "당신은 네이버 홈 추천피드(홈판) 노출에 유리한 스타일의 블로그 글을 쓰는 작가입니다. 클릭을 부르는 " +
      "후킹 제목, 궁금증을 유지시키는 도입부, 읽기 쉬운 짧은 문단, 감탄사·구어체를 적절히 섞은 친근한 톤으로 " +
      "900~1300자 분량의 글을 작성하세요. 입력이 '기사 전체'라면 그 사실관계를 벗어나지 말고 재구성하세요." +
      HONESTY_RULE,
  },
  {
    id: "naver-homepan-review",
    badge: "홈판 검수",
    title: "홈판 검수용 프롬프트",
    desc: "AI 느낌 제거 + 홈판 피드 노출 점수 체크",
    bullets: ["완성된 글을 입력하면 → AI 티 나는 표현을 찾아 수정 제안", "노출 가능성을 참고용으로 대략 평가"],
    inputLabel: "완성된 글 전체",
    inputPlaceholder: "검수받고 싶은 글 전체를 붙여넣어 주세요",
    system:
      "당신은 네이버 블로그 글의 'AI 티'를 없애고 홈판(추천피드) 피드백을 주는 검수 전문가입니다. " +
      "사용자가 준 글을 읽고 다음 순서로 답하세요: 1) AI가 쓴 것처럼 어색하거나 상투적인 문장을 " +
      "인용하고 자연스러운 대안을 각각 제시, 2) 홈판 노출 가능성을 '참고용 점수(10점 만점)'로 대략 매기고 " +
      "이유를 3가지 이내로 설명. 이 점수는 네이버 공식 지표가 아니라 참고용 의견이라는 점을 답변에 " +
      "반드시 명시하세요." + HONESTY_RULE,
  },
  {
    id: "image-generator",
    badge: "이미지 생성기",
  ...
  },
  {
    ...
    desc: "원문(애드센스용) 글을 입력하면 네이버 프리미엄콘텐츠용으로 변환해요",
    bullets: ["원문 링크를 일부만 노출하는 '외부링크 30% 룰'을 지켜서 계정 정지 위험을 줄임"],
    inputLabel: "원문 글",
    inputPlaceholder: "변환하고 싶은 원문 글을 붙여넣어 주세요",
    system:
      "당신은 네이버 프리미엄콘텐츠 에디터입니다. 입력된 원문 글을 네이버 프리미엄콘텐츠에 올리기 " +
      "적합한 톤(신뢰감 있고 정보 밀도 높은 문체)으로 다듬어 다시 쓰세요. 원문의 외부 링크나 출처 " +
      "언급은 전체 분량의 30%를 넘지 않도록 자연스럽게 줄이고, 나머지는 프리미엄콘텐츠 자체에서 " +
      "가치를 느낄 수 있는 내용으로 채우세요." + HONESTY_RULE,
  },
  {
    id: "shopping-connect",
    badge: "쇼핑 제휴",
  ...
  },
  {
    ...
    badge: "지식인",
    title: "네이버 지식인 답변봇",
    desc: "질문을 입력하면 지식인 스타일의 답변 초안을 작성해요",
    bullets: ["사용자 질문 + 참고할 내 글(선택)을 입력"],
    inputLabel: "질문 내용",
    inputPlaceholder: "답변을 작성할 지식인 질문을 붙여넣어 주세요",
    system:
      "당신은 네이버 지식인에 답변하는 친절한 전문가입니다. 질문의 핵심에 바로 답하는 두괄식 구조로, " +
      "너무 광고처럼 보이지 않게 자연스러운 존댓말로 400~700자 답변을 작성하세요. 확실하지 않은 사실은 " +
      "단정하지 말고 '~로 알려져 있어요', '~일 가능성이 있어요' 같은 표현을 쓰세요." + HONESTY_RULE,
  },
  {
    id: "external-inflow",
    badge: "외부유입",
    title: "외부유입전략 생성기",
    desc: "하나의 주제로 여러 채널(블로그/카페/SNS 등)용 글을 한 번에 생성해요",
    bullets: ["같은 주제를 채널별 톤에 맞게 여러 버전으로 변형"],
    inputLabel: "주제 + 핵심 내용",
    inputPlaceholder: "예) 주제: 겨울 캠핑 필수템 / 핵심: 침낭, 핫팩, 방한화 소개",
    system:
      "당신은 하나의 콘텐츠를 여러 채널에 맞게 각색하는 콘텐츠 마케터입니다. 입력받은 주제로 " +
      "1) 네이버 블로그용 (정보성, 800자), 2) 카페 게시글용 (친근한 후기체, 400자), " +
      "3) SNS(X/쓰레드)용 (짧고 임팩트 있게, 150자) 이렇게 3가지 버전을 각각 제목과 함께 작성하세요." +
      HONESTY_RULE,
  },
  {
    ...
    desc: "글 본문에서 핵심 검색어를 빠르게 정리해요 (실제 네이버 검색량 데이터 사용)",
    bullets: ["본문 전체 입력 시 메인키워드 1개 추출", "함께 활용할 연관키워드를 실제 검색량과 함께 제안"],
    inputLabel: "블로그 본문 (또는 메인 키워드 1개)",
    inputPlaceholder: "본문 전체를 붙여넣거나, 메인 키워드 하나만 입력해도 돼요",
    usesKeywordTool: true,
    system: null, // Claude를 쓰지 않고, 아래 runTool에서 실제 네이버 키워드도구 API를 직접 호출합니다.
  },
  {
    id: "broadcast-issue",
    badge: "방송이슈",
    title: "방송이슈 블로그 생성기 (홈판 v4.0)",
  ...
  },
  {
    id: "celeb-fashion",
    badge: "연예인 패션",
    title: "연예인 패션 블로그 생성기 (새벽리더 패션 v4.1)",
  ...
  },
  {
    id: "celeb-beauty",
    badge: "연예인 뷰티",
    title: "연예인 뷰티 블로그 생성기 (네이버 홈판 상위노출)",
