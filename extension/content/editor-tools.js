...
(() => {
  ...
  function fmtMeasured(mz) {
    ...
    // ⚠️ 2026-09-01: 사장님이 실측보다 촘촘한 강조를 원하셔서 밀도를 올렸습니다.
    // 이 줄이 "그 비율로 맞췄습니다"라고 하면 거짓말이 됩니다. 사실대로 적습니다.
    return `실측으로는 1,000자에 ${parts.join(" · ")}번입니다. ` +
           `사장님 지시로 이보다 촘촘하게 넣습니다(굵게 9 · 글자색 3 · 밑줄 1.5 · 배경색 1).`;
  }
